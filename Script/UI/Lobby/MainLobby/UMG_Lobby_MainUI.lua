...
---@field Normal_Debris UMG_Lobby_Coin_C
---@field Rare_Debris UMG_Lobby_Coin_C
---@field ReadyGame UMG_Lobby_StartGame_C
---@field SelectDifficulty UMG_Lobby_StartGame_C
---@field SuperRare_Debris UMG_Lobby_Coin_C
---@field UMG_GamePlayer1 UMG_GamePlayer_C
---@field UMG_GamePlayer2 UMG_GamePlayer_C
---@field UMG_GamePlayer3 UMG_GamePlayer_C
---@field UMG_GamePlayer4 UMG_GamePlayer_C
---@field UMG_Lobby_IfAddOtherPlayers UMG_Lobby_IfAddOtherPlayers_C
---@field UMG_Lobby_ModeSelect UMG_Lobby_ModeSelect_C
